            ...
            <form class="form" action="paypal_ec_mark.php" method="POST">
               <div class="row-fluid">
                  <div class="span6 inner-span">
					...
					<tr><td colspan="2">
						<input id="p_method_paypal_express" value="paypal_express" type="radio" name="payment[method]" title="PayPal Express Checkout" class="radio" checked>
					...
					<tr><td colspan="2"><input id="p_method_paypal_express" value="paypal_express" type="radio" name="payment[method]" title="PayPal Express Checkout" class="radio" readonly>&nbsp;Credit Card</td></tr>
					<tr><td>&nbsp;</td></tr>
						<tr><td><input type="submit" class="btn btn-primary btn-large" name="Confirm" value="Place Order" src="https://www.paypalobjects.com/webstatic/en_US/i/buttons/checkout-logo-large.png" alt="Check out with PayPal"/></td></tr>
                        </table>
                  </div>
               </div>
            </form>
